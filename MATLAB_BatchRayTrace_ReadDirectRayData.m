function [ xData,yData,zData,lData,mData,nData,l2Data,m2Data,n2Data,n1,n2 ] = MATLAB_BatchRayTrace_ReadDirectRayData( surface, nrays, hx, hy, dPx, dPy, filename )
...
if isempty(TheApplication)
    ...
    try
        [ xData,yData,zData,lData,mData,nData,l2Data,m2Data,n2Data,n1,n2 ] = BeginApplication(TheApplication, surface, nrays, hx, hy, dPx, dPy, filename);
...
function [ xData,yData,zData,lData,mData,nData,l2Data,m2Data,n2Data,n1,n2 ] = BeginApplication(TheApplication, surface, nrays, hx, hy, dPx, dPy, filename)
    ...
    disp('number of surfaces')
    disp(TheSystem.LDE.NumberOfSurfaces)
    disp('Tracing to surface, tracing to arbitrary surface bypassed')
    disp(surface)
    max_rays = nrays;
    ...
    % are rayTypes?
    RayTraceData = raytrace.CreateNormUnpol(total_rays_in_both_axes, ZOSAPI.Tools.RayTrace.RaysType.Real,0, surface);
    ...
    while ~isFinished
        ...
        if readSegments == 0
            ...
            % Position Data
            xData_in = rayData.X.double;
            yData_in = rayData.Y.double;
            zData_in = rayData.Z.double;
